...
public class AzureClient {
    ...
    public AzureClient(HttpClient httpClient, String baseUri, String tenantId, String clientId, String clientSecret, Integer timeout) {
    ...
    private void authenticate() {
        ...
        try {
            ...
            Gson gson = new Gson();
            token = gson.fromJson(new InputStreamReader(response.getEntity().getContent()), OAuthToken.class);
            token.setExpiresOn();
